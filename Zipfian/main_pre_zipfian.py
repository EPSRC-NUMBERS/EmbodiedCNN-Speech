'''
pre-trained baseline with Zipfian distribution
'''
...
for k in range(reps):
	...
	for i in range(nsplit):
		...
		model = emb_cnn_full(model1, INPUT_SHAPE, NUM_CLASSES, embodied=False)

		plot_model(model,to_file=folder+'one-hot_pretraining.png')
