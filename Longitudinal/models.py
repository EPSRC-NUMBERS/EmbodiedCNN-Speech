''' all the models for the spoken digits recognition are here
'''
...
def emb_cnn_pre(features_shape, num_outputs, act='relu', act2='sigmoid'):
	# pre-trained convolutional blocks
...
def deep_cnn(features_shape, num_classes, act='relu',batch_norm=False):
